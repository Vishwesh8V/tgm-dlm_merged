#!/usr/bin/env bash
# ==============================================================================
# Shell Script: Generation-Only Trajectory Sampling -- 100 Test Examples
#
# Scoped-down variant of run_full_trajectory_pipeline.sh:
#   - generation task ONLY (no retro, no forward)
#   - --num_samples 100 instead of 1000 (first 100 examples of the test split
#     -- text_sample.py's start_idx defaults to 0, so num_samples=100 alone
...
OUTPUT_SUBDIR="trajectory_sweep_100test"
...
echo "======================================================================"
echo " Generation-Only Trajectory Sampling -- 100 Test Examples"
...
for K in "${STEPS_LIST[@]}"; do
    ...
    for ORDER in "${ORDERS[@]}"; do
        ...
        echo "" && echo "=== K=${K} order=${ORDER}: Stage 5 -- sampling (100 test examples) ==="
